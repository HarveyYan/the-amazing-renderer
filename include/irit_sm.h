...
#ifdef DEBUG
    #define  IRIT_VERSION	"Ver. 10D"		 /* Program version. */
#else
    #define  IRIT_VERSION	"Ver. 10"		 /* Program version. */
#endif
#define  IRIT_COPYRIGHT	"(C) Copyright 1989-2008 Gershon Elber, Technion"
...
#if defined(LINUX386) || defined(SUN4)
...
#define IRIT_OBJ_NAME_LEN	31			/* Names of objects. */
...
#if defined(__WINNT__) && _MSC_VER >= 1400
