...
CagdCrvStruct *SymbComposeCrvCrv(CagdCrvStruct *Crv1,
				 CagdCrvStruct *Crv2);
...
CagdCrvStruct *SymbComposeSrfCrv(CagdSrfStruct *Srf,
				 CagdCrvStruct *Crv);
...
CagdCrvStruct *SymbApproxCrvAsBzrQuadratics(const CagdCrvStruct *Crv,
					    CagdRType Tol,
					    CagdRType MaxLen);
CagdCrvStruct *BzrComposeCrvCrv(CagdCrvStruct *Crv1,
				CagdCrvStruct *Crv2);
CagdCrvStruct *BzrComposeSrfCrv(CagdSrfStruct *Srf,
				CagdCrvStruct *Crv);
CagdCrvStruct *BzrComposeSrfCrvInterp(CagdSrfStruct *Srf,
				      CagdCrvStruct *Crv);
...
struct IPObjectStruct *SymbSrfCnvxHull(const CagdSrfStruct *Srf,
				       CagdRType Fineness);
struct IPObjectStruct *SymbTwoSrfTangencies(const CagdSrfStruct *Srf1,
					    const CagdSrfStruct *Srf2,
					    CagdRType Fineness);
struct IPObjectStruct *SymbThreeSrfTangencies(const CagdSrfStruct *Srf1,
					      const CagdSrfStruct *Srf2,
...
******************************************************************************/
SymbNormalConeStruct *SymbTangentConeForCrv(const CagdCrvStruct *Crv,
					    int Planar);
SymbNormalConeStruct *SymbNormalConeForSrf(const CagdSrfStruct *Srf);
